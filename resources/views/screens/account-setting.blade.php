...
<section id="subscription-section" class="common-section">
    ...
    <button class="open-sidebar"><i class="fa fa-arrow-left" aria-hidden="true"></i></i></button>
         <ul class="nav nav-pills" role="tablist">
               ...
               <li class="nav-item">
                  <a href="#account" class="nav-link my-project active" data-toggle="pill"> <img src="assets/img/Icons/Icon feather-search - off.png" alt="" class="img-fluid"><span><i class="fa fa-user" aria-hidden="true"></i> Account Setting</span> </a>
               </li>
               <li class="nav-item">
